...
public class SudokuFrame extends JFrame {
	...
	public SudokuFrame() {
		...
		this.setMinimumSize(new Dimension(800,600)); //window
		
		JMenuBar menuBar = new JMenuBar();
		JMenu file = new JMenu("Game");
		JMenu newGame = new JMenu("New Game");
		JMenuItem nineByNineGame = new JMenuItem("9 By 9 Game");
		nineByNineGame.addActionListener(new NewGameListener(SudokuPuzzleType.NINEBYNINE,26)); //new game 9x9
	...
	public void rebuildInterface(SudokuPuzzleType puzzleType,int fontSize) {
		...
		for(String value : generatedPuzzle.getValidValues()) {		// button generator
