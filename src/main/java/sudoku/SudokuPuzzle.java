...
public class SudokuPuzzle extends SudokuMakers{
	...
	public void makeMove(int row,int col,String value, int count) {
	...
	public boolean isValidMove(int row,int col,String value) {
		if(answers[row][col] == value) { //!numInCol(col,value) && !numInRow(row,value) && !numInBox(row,col,value)
			return true;
		}
		return false;
	}
